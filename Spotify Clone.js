...
chaleyaPlayButton.addEventListener("click", () => {
    let songData = playedSong.innerHTML = `<audio src="/Chaleya_320(PagalWorld.com.se).mp3" autoplay id="played__song"></audio>`;
    songDetails.innerHTML = `<div class="album" id="played_song">
    <img src="/Chaleya-From-Jawan-Hindi-2023-20230814014337-500x500.jpg" alt="#" class="song-image">
    <div class="song-detais">
        <p class="song-name">Chaleya</p>
        <p class="singer-name">Arijit Singh, Shilpa Rao</p>
    </div>
    <img src="/album_icon1.jpg" alt="#" class="song-icon1">
    <img src="/album_icon2.jpg" alt="#" class="song-icon2">
</div>`;
})
heeriyePlayButton.addEventListener("click", () => {
    let songData = playedSong.innerHTML = `<audio src="/Heeriye-Heeriye-Aa(PaglaSongs).mp3" autoplay id="played__song"></audio>`;
    songDetails.innerHTML = `<div class="album" id="played_song">
    <img src="/Heeriye.jpg" alt="#" class="song-image">
    <div class="song-detais">
...
kuleyKuleyPlayButton.addEventListener("click", () => {
    let songData = playedSong.innerHTML = `<audio src="/Kuley Kuley Honey 3.0 128 Kbps.mp3" autoplay id="played__song"></audio>`;
    songDetails.innerHTML = `            <div class="album" id="played_song">
    <img src="/Kuley-Kuley-From-Honey-3-0-Punjabi-2023-20230914113553-500x500.jpg" alt="#" class="song-image">
    <div class="song-detais">
